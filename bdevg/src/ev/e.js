...
// img
import previewImage from "./img/tablet-ipad-svgrepo-com.svg";
import fullScreenImage from "./img/expand-fullscreen-svgrepo-com.svg";
...
export default function E(props) {
    ...
    function createPreviewStyleButton(){
        ...
        el.innerHTML = `<img src=${previewImage} alt='preview style bbutton'></img>`;
    ...
    function createFullScreenButton() {
        const el = document.createElement("button");
        el.innerHTML = `<img src=${fullScreenImage} alt='full screen  button'></img>`;
        el.onclick = (e)=>{
